...
export default function Home() {
  ...
  const tDesc = useTranslations('Desc');
  return (
      <>
          ...
          <div className="container">
            <div className="main-banner">
              <div className="main-banner-content">
                ...
                <h1 className='main-banner-content__title' dangerouslySetInnerHTML={{__html: t('main')}}/>
                <p className="main-banner-content__desc">
                  {tDesc('descMain')}
                </p>
                <Link href='https://t.me/teleboom1tv_bot' target='_blank' className="main-banner-content__link">
                  {tButton('goTelegram')}
                </Link>
              </div>
            </div>
        ...
        <section className="section promotion__container" id="rules">
          <div className="container">
              ...
              <div className="promotion__list">
                ...
                <div className="promotion__item promotion-item">
                  ...
                  <div className="promotion-item__text">
                    ...
                    <div className="promotion-item__desc">Период проведения акции с 8 декабря 2023 года до 21 января
                      2024 года, включая срок регистрации чеков до 17 января 2024 года
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="section winners__container" id="winners">
          <div className="container">
